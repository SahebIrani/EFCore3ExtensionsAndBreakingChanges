...
namespace WebApp.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public ApplicationDbContext(string database)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder
                .UseSqlServer($"Server=.\\SQL2017;Database=SinjulMSBH;Integrated Security=True;")
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var sql = this.Blogs.Where(p => EFCore.DateDiff(DatePart.day, DateTimeOffset.Now, p.Date) < 50).ToSql();
