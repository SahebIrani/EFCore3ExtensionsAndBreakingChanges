...
namespace Sample
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void AddOnDeleteBehavior(this ModelBuilder modelBuilder)
        {
        ...
        public static void ApplyConfigFromAssembly(this ModelBuilder modelBuilder, params Assembly[] assemblies)
        {
        ...
        public static void ApplyEntityFromAssembly<BaseType>(this ModelBuilder modelBuilder, params Assembly[] assemblies)
        {
        ...
        public static readonly MethodInfo _asQueryableMethodInfo
                = typeof(Queryable)
